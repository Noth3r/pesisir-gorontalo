      ...
      <div className="container relative z-10 mx-auto flex h-full flex-col items-center justify-center gap-y-12 px-4 py-16 text-white xl:gap-y-20">
        <div className="font-cocogoose md:pt-20 xl:pt-40 2xl:pt-44">
          ...
          <h2 className="text-center text-xl font-light">
            ...
            <span className="font-sans font-medium">2024</span>
          </h2>
        </div>
        <h1 className="text-center font-beach text-4xl xl:text-5xl text-yellowish-100">
        ...
        <div className="flex w-full flex-col justify-between gap-y-8 px-8 md:w-1/2 xl:w-2/5">
          {infoOprec.map((item, index) => (
            <div key={index} className="flex items-center justify-between">
              <p className="font-cocogoose xl:text-4xl text-white">{item.name}</p>
